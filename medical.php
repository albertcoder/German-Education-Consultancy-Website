			...
			<div id="main">
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								<h2>Medical and Public Health</h2>
							</header>
							...
							<p></p>
							<table>
								<tr><td> Dentistry</td> <td>Medicine </td></tr>	
								<tr><td> Nursing and Public Health Studies</td> <td>Pharmacy </td></tr>	
								<tr><td> Therapy Professions</td> <td>Veterinary Medicine </td></tr>	
							</table>
						</div>
					</section>
