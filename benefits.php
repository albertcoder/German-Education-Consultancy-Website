			...
			<div id="main">
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								<h2>Benefits of Study in Germany</h2>
							</header>

							<a href="#" class="image featured"><img src="images/.jpg" alt="" /></a>

							<li><b>Very low or no tuition fee:</b> German universities are state funded and hence charge very nominal  or no tuition fee from students.</li>
							<li><b>Low cost of living:</b> Cost of living is low compared to other world educational destinations.</li>
							<li><b>Top level:</b> Education from Germany takes you to a level where you can compete at world level.</li>
						</div>
					</section>
